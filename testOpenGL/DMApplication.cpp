...
DMApplication::DMApplication(HINSTANCE hInstance) : m_hInstance(hInstance), m_bFullScreen(false) {}

DMApplication::~DMApplication() {}

void DMApplication::ParseCmdLine(LPSTR lpCmdLine) {
...
void DMApplication::Run() {

	// Create the main window first
	DMMainWindow mainWindow(800, 600, m_bFullScreen);
